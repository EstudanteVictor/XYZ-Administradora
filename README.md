...
- **Número do cartão mascarado por meio de checkbox** na grid e no Excel exportado (mostra só os 4 últimos dígitos); o valor completo só aparece no banco e na tela de cadastro/edição.
